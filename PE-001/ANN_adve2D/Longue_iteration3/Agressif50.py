...
reseau = tf.keras.models.load_model("Agressif50_0063.h5",custom_objects={'f_loss': f_loss})
inputscaler = load('input_scalerAgressif50.bin')
outputscaler = load('output_scalerAgressif50.bin')
...
while iteration < 1500:
    ...
    if iteration % 20 == 0:
        ...
        fig.savefig(f"Agressif50_RBC350_it{iteration}.png")
        plt.show()
