...
def f_loss(y_true, y_pred):
    ...
    dx_tensor=tf.constant(1/99)
    dy_tensor=tf.constant(1/99)
    e = 0.0001
    n = 2
...
reseau = tf.keras.models.load_model("Rachadi_640DL_gauss100.h5",custom_objects={'f_loss': f_loss})
inputscaler = load('input_scaler100.bin')
outputscaler = load('output_scaler100.bin')
...
while iteration < 1000:
    ...
    if iteration % 50 == 0:
        ...
        fig.savefig(f"solinitialefigs{iteration}.png")
        plt.show()
