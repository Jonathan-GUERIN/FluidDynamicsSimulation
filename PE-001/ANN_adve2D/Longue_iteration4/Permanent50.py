...
reseau = tf.keras.models.load_model("Permanent50_0325.h5",custom_objects={'f_loss': f_loss})
inputscaler = load('input_scalerPermanent50.bin')
outputscaler = load('output_scalerPermanent50.bin')
...
while iteration < 1500:
    ...
    if iteration % 20 == 0:
        ...
        fig.savefig(f"Permanent50_RBC350_it{iteration}.png")
        plt.show()
