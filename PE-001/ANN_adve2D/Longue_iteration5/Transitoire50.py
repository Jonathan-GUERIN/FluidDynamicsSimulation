...
def f_loss(y_true, y_pred):
    ...
    dx_tensor=tf.constant(1/49)
    dy_tensor=tf.constant(1/49)
    e = 0.005
    n = 2
...
reseau = tf.keras.models.load_model("Transitoire50_0299.h5",custom_objects={'f_loss': f_loss})
inputscaler = load('input_scalerTransitoire50.bin')
outputscaler = load('output_scalerTransitoire50.bin')
...
while iteration < 1500:
    ...
    if iteration % 20 == 0:
        ...
        fig.savefig(f"Transitoire50_RBC350_it{iteration}.png")
        plt.show()
